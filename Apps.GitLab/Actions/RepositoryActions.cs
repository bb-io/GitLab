...
public class RepositoryActions : GitLabActions
{
    ...
    [Action("Get repository issues", Description = "Get open issues in a repository")]
    ...
    [Action("Get repository merge requests", Description = "Get open merge requests in a repository")]
    ...
    [Action("List repository folder content", Description = "Search folder content in a repository")]
    ...
    [Action("List repositories", Description = "Search repositories available to connection")]
    ...
    [Action("Get files by filepaths", Description = "Get files from a repository by file paths")]
    ...
    [Action("Branch exists", Description = "Check whether branch exists in a repository")]
